...
class ConfigController {
  ...
  @Get()
  get() {
    return { backdateMaxDays: APP_CONFIG.backdateMaxDays, maxTaskHours: APP_CONFIG.maxTaskHours, taskEntryWindowMinutes: APP_CONFIG.taskEntryWindowMinutes, dashboardNotice: APP_CONFIG.dashboardNotice };
  }
